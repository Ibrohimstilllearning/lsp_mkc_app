...
import 'package:lsp_mkc_app/pages/scheme_detail_page.dart';

class RegistrationSchemeListPage extends StatelessWidget {
  const RegistrationSchemeListPage({super.key});
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return GestureDetector(
              onTap: () {
                Get.to(() => SchemeDetailPage(scheme: scheme));
              },
              child: Container(
