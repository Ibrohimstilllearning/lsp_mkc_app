...
class FormApl01Bagian2 extends StatelessWidget {
  ...
  final List<Map<String, String>> tujuanOptions = [
    ...
    {"value": "pengakuan_kompetensi_terkini",  "label": "Pengakuan Kompetensi Terkini (PKT)"},
    {"value": "rekognisi_pembelajaran_lampau",  "label": "Rekognisi Pembelajaran Lampau (RPL)"},
            ...
            _card(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  const Text("Pilih satu atau lebih tujuan asesmen",
                      style: TextStyle(
                          fontSize: 12, color: Color(0xFF9CA3AF))),
                  const SizedBox(height: 14),
                  ...tujuanOptions.map((opt) => Obx(() {
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 10),
                      const Expanded(
                        child: Text("Daftar Unit Kompetensi",
                            style: TextStyle(
                                fontSize: 14,
                                fontWeight: FontWeight.w700,
                                color: Color(0xFF111827))),
                  ...
                  const SizedBox(height: 4),
                  const Text("Sesuai kemasan skema sertifikasi",
                      style: TextStyle(fontSize: 12, color: Color(0xFF9CA3AF))),
                  const SizedBox(height: 14),
                  ...unitKompetensi.map((item) => Container(
                        margin: const EdgeInsets.only(bottom: 8),
