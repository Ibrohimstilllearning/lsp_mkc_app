...
import 'package:lsp_mkc_app/pages/forms/form_apl01pt3.dart';
                    ...
                    children: [
                      ...
                      ...unitKompetensi.map((item) => TableRow(
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.all(8),
                            child: Text(item["kode"]!, style: TextStyle(fontSize: 12)),
                          ),
                          Padding(
                            padding: EdgeInsets.all(8),
                            child: Text(item["judul"]!, style: TextStyle(fontSize: 12)),
                          ),
                        ],
                      )),
                    ],
